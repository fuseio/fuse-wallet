...
class SwapScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, _SwapModel>(
        distinct: true,
        onInitialBuild: (viewModel) {
          Segment.screen(screenName: '/receive-screen');
        },
        converter: _SwapModel.fromStore,
        builder: (_, viewModel) {
...
class _SwapModel extends Equatable {
  final String walletAddress;
  _SwapModel({
    this.walletAddress,
  });

  static _SwapModel fromStore(Store<AppState> store) {
    return _SwapModel(
