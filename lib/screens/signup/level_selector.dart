...
class _LevelSelectorScreenState extends State<LevelSelectorScreen> {
  ...
  Widget build(BuildContext context) {
    return MainScaffold(title: "Select mode", children: <Widget>[
          ...
          child: Column(
            children: <Widget>[
              ...
              Padding(
                ...
                child: RaisedButton(
                  onPressed: () {},
                  child: Text('New to Crypto', style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold, color: Colors.green),),
                ),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 40, left: 40, right: 40),
                child: RaisedButton(
                  onPressed: null,
                  child: Text('Pro', style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold, color: Colors.grey),),
                ),
              ),
            ],
          ),
