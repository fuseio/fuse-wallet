...
import 'package:bit2c/models/views/send_amount.dart';
import 'package:bit2c/screens/send/send_amount_arguments.dart';
import 'package:bit2c/screens/send/send_success.dart';
                ...
                viewModel.isProMode
                    ...
                    : (args.accountAddress == null || args.accountAddress.isEmpty)
                        ? Padding(
                            ...
                            child: Text(
                                '''Sending money to ${args.name != null ? args.name : 'friend'} will automatically invite them to Bit2c and let them redeem the funds you sent''',
                                textAlign: TextAlign.center,
                                style: TextStyle(
