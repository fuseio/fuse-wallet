...
import 'package:localpay/utils/jwt.dart';
      ...
      try {
        ...
        if (initialState?.userState?.jwtToken != '') {
          ...
          if (diff.inDays <= 1) {
            ...
            jwtToken = await api.login(token.token, initialState.userState.accountAddress, initialState.userState.identifier, appName: "LocalPay");
          }
