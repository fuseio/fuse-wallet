...
import 'package:localdolarmx/redux/middlewares/auth_middleware.dart';
import 'package:localdolarmx/models/app_state.dart';
import 'package:localdolarmx/redux/reducers/app_reducer.dart';
import 'package:localdolarmx/redux/state/state_secure_storage.dart';
import 'package:localdolarmx/utils/phone.dart';
import 'package:localdolarmx/utils/jwt.dart';
      ...
      try {
        ...
        if (initialState?.userState?.jwtToken != '') {
          ...
          if (diff.inDays <= 1) {
            ...
            jwtToken = await api.login(token.token, initialState.userState.accountAddress, initialState.userState.identifier, appName: 'LocalDolarMX');
          }
