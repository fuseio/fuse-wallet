...
import 'package:BIM/redux/middlewares/auth_middleware.dart';
import 'package:BIM/models/app_state.dart';
import 'package:BIM/redux/reducers/app_reducer.dart';
import 'package:BIM/redux/state/state_secure_storage.dart';
import 'package:BIM/utils/phone.dart';
import 'package:BIM/utils/jwt.dart';
      ...
      try {
        ...
        if (initialState?.userState?.jwtToken != '') {
          ...
          if (diff.inDays <= 1) {
            ...
            jwtToken = await api.login(token.token, initialState.userState.accountAddress, initialState.userState.identifier, appName: "BIM");
          }
