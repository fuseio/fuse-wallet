...
import 'package:farmlyledger/redux/middlewares/auth_middleware.dart';
import 'package:farmlyledger/models/app_state.dart';
import 'package:farmlyledger/redux/reducers/app_reducer.dart';
import 'package:farmlyledger/redux/state/state_secure_storage.dart';
import 'package:farmlyledger/utils/phone.dart';
import 'package:farmlyledger/utils/jwt.dart';
      ...
      try {
        ...
        if (initialState?.userState?.jwtToken != '') {
          ...
          if (diff.inDays <= 1) {
            ...
            jwtToken = await api.login(token.token, initialState.userState.accountAddress, initialState.userState.identifier, appName: 'FarmlyLedger');
          }
