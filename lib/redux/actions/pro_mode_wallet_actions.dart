...
import 'package:fc_knudde/constans/exchangable_tokens.dart';
import 'package:fc_knudde/models/community/community.dart';
import 'package:fc_knudde/models/jobs/swap_token_job.dart';
import 'package:fc_knudde/models/pro/price.dart';
import 'package:fc_knudde/models/pro/pro_wallet_state.dart';
...
import 'package:fc_knudde/redux/actions/error_actions.dart';
  ...
  return (Store store) async {
    ...
    if (exchangableTokens.containsKey(checksumEthereumAddress(tokenAddress))) {
      ...
      try {
        ...
        logger.severe('Error while get Token Details for $tokenAddress');
      }
    }
  };
}
