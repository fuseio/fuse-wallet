...
import 'package:straitsx/utils/biometric_local_auth.dart';
...
ThunkAction setCountryCode(CountryCode countryCode) {
  return (Store store) async {
    ...
    store.dispatch(SetIsoCode(countryCode: countryCode, normalizedPhoneNumber: normalizedPhoneNumber));
  };
}
...
ThunkAction setDeviceId(bool reLogin) {
  return (Store store) async {
    ...
    if (reLogin) {
      ...
      String jwtToken = await api.login(token, accountAddress, identifier, appName: 'StraitsX');
