...
import 'package:fusecash/presentation/home/widgets/token_tile.dart';
import 'package:fusecash/redux/viewsmodels/trade.dart';
import 'package:fusecash/services/apis/exchange.dart';
import 'package:fusecash/utils/debouncer.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:fusecash/generated/i18n.dart';
import 'package:fusecash/models/app_state.dart';
import 'package:fusecash/models/tokens/token.dart';
import 'package:fusecash/presentation/home/widgets/card.dart';
...
Future<dynamic> fetchSwap(
  ...
  try {
    if (fromTokenAddress != null &&
      ...
      final Exchange exchange = getIt<Exchange>();
      Map<String, dynamic> response =
          await exchange.swap(walletAddress, data: apiOptions);
    ...
    log.error('ERROR in fetchSwap - ${error.toString()}');
  }
}
