...
import 'package:contacts_service/contacts_service.dart' as _i31;
...
import '../../features/buy/screens/business.dart' as _i20;
import '../../features/buy/screens/businesses_list_page.dart' as _i19;
...
import '../../features/contacts/send_amount_arguments.dart' as _i32;
...
import '../../models/actions/wallet_action.dart' as _i30;
import '../../models/community/business.dart' as _i33;
...
class RootRouter extends _i11.RootStackRouter {
  ...
  final Map<String, _i11.PageFactory> pagesMap = {
    ...
    BusinessesListScreen.name: (routeData) {
      final args = routeData.argsAs<BusinessesListScreenArgs>();
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i19.BusinessesListScreen(
              args.businesses, args.token, args.title));
    },
    BusinessScreen.name: (routeData) {
      ...
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData,
          child:
              _i20.BusinessScreen(business: args.business, token: args.token));
    },
    ...
    ShowMnemonic.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i22.ShowMnemonic());
    },
    VerifyMnemonic.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i23.VerifyMnemonic());
    },
    DoneBackup.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i24.DoneBackup());
    },
    SettingsScreen.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i25.SettingsScreen());
    },
    ProtectYourWallet.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i26.ProtectYourWallet());
    },
    ProfileScreen.name: (routeData) {
      final args = routeData.argsAs<ProfileScreenArgs>(
          orElse: () => const ProfileScreenArgs());
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i27.ProfileScreen(key: args.key));
    }
  };
        ...
        _i11.RouteConfig(MainScreen.name, path: '/main-screen', guards: [
          ...
          _i11.RouteConfig(BuyTab.name,
              ...
              children: [
                ...
                _i11.RouteConfig(BusinessesListScreen.name,
                    path: 'businesses-list-screen', parent: BuyTab.name),
...
/// generated route for [_i2.ChooseSecurityOption]
...
/// generated route for [_i3.PinCodeScreen]
...
/// generated route for [_i4.RestoreFromBackupScreen]
...
/// generated route for [_i5.OnBoardScreen]
...
/// generated route for [_i6.SignUpScreen]
...
/// generated route for [_i7.VerifyPhoneNumber]
...
/// generated route for [_i8.UserNameScreen]
...
/// generated route for [_i9.WebViewScreen]
...
/// generated route for [_i10.MainScreen]
class MainScreen extends _i11.PageRouteInfo<MainScreenArgs> {
  MainScreen({_i28.Key? key, List<_i11.PageRouteInfo>? children})
      : super(name,
            path: '/main-screen',
...
/// generated route for [_i13.ActionDetailsScreen]
class ActionDetailsScreen extends _i11.PageRouteInfo<ActionDetailsScreenArgs> {
  ActionDetailsScreen(
      {required _i30.WalletAction action,
      _i28.ImageProvider<Object>? image,
      required String displayName,
      String? accountAddress,
      required String symbol,
      _i31.Contact? contact})
      : super(name,
            path: 'action-details-screen',
...
class ActionDetailsScreenArgs {
  ...
  final _i30.WalletAction action;

  final _i28.ImageProvider<Object>? image;
...
/// generated route for [_i14.ContactsList]
class ContactsList extends _i11.PageRouteInfo<ContactsListArgs> {
  ContactsList({_i32.SendFlowArguments? pageArgs})
...
class ContactsListArgs {
  ...
  final _i32.SendFlowArguments? pageArgs;
...
/// generated route for [_i15.SendAmountScreen]
class SendAmountScreen extends _i11.PageRouteInfo<SendAmountScreenArgs> {
  SendAmountScreen({required _i32.SendFlowArguments pageArgs})
      : super(name,
            path: 'send-amount',
...
/// generated route for [_i16.SendReviewScreen]
class SendReviewScreen extends _i11.PageRouteInfo<SendReviewScreenArgs> {
  SendReviewScreen({required _i32.SendFlowArguments pageArgs})
      : super(name,
            path: 'send-review',
...
/// generated route for [_i17.SendSuccessScreen]
class SendSuccessScreen extends _i11.PageRouteInfo<SendSuccessScreenArgs> {
  SendSuccessScreen({required _i32.SendFlowArguments pageArgs})
      : super(name,
            path: 'send-success',
...
/// generated route for [_i18.BuyScreen]
...
/// generated route for [_i19.BusinessesListScreen]
class BusinessesListScreen
    extends _i11.PageRouteInfo<BusinessesListScreenArgs> {
  BusinessesListScreen(
      {required List<_i33.Business> businesses,
      required _i34.Token token,
      required String title})
      : super(name,
            path: 'businesses-list-screen',
            args: BusinessesListScreenArgs(
                businesses: businesses, token: token, title: title));

  static const String name = 'BusinessesListScreen';
}

class BusinessesListScreenArgs {
  const BusinessesListScreenArgs(
      {required this.businesses, required this.token, required this.title});

  final List<_i33.Business> businesses;

  final _i34.Token token;

  final String title;

  @override
  String toString() {
    return 'BusinessesListScreenArgs{businesses: $businesses, token: $token, title: $title}';
  }
}

/// generated route for [_i20.BusinessScreen]
class BusinessScreen extends _i11.PageRouteInfo<BusinessScreenArgs> {
  BusinessScreen({required _i33.Business business, required _i34.Token token})
      : super(name,
...
/// generated route for [_i21.AccountScreen]
...
/// generated route for [_i22.ShowMnemonic]
...
/// generated route for [_i23.VerifyMnemonic]
...
/// generated route for [_i24.DoneBackup]
...
/// generated route for [_i25.SettingsScreen]
...
/// generated route for [_i26.ProtectYourWallet]
...
/// generated route for [_i27.ProfileScreen]
