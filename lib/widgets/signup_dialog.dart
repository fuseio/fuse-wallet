              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                        "The supervenice wallet stores private information locally on the device. Only the phone number is used to be able to verify your identity and reduce friction when sending money to phone contacts.",
                        style: TextStyle(
                            color: Theme.of(context).primaryColor,
                            fontSize: 14,
                    ...
                    const SizedBox(height: 20.0),
                    Text(
                        "superveniceta will never share this information with 3rd party.",
                        style: TextStyle(
                            color: Theme.of(context).primaryColor,
                            fontSize: 14,
                            fontWeight: FontWeight.normal)),
