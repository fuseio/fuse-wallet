...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "activity": MessageLookupByLibrary.simpleMessage("Деятельность"),
        ...
        "auth_failed_message": MessageLookupByLibrary.simpleMessage(
            "Пожалуйста, попробуйте еще раз, чтобы продолжить\n"),
        "auth_failed_title":
            MessageLookupByLibrary.simpleMessage("Ошибка аутентификации"),
        "available": MessageLookupByLibrary.simpleMessage("имеется в наличии"),
        "back_up":
        ...
        "bridge_from_BSC": MessageLookupByLibrary.simpleMessage(
            "Передвигайте ETH или BNB через мост с Binance Smart Chain"),
        "bridge_from_ethereum": MessageLookupByLibrary.simpleMessage(
            "Передвигайте цифровые активы из сети Ethereum"),
        ...
        "crypto_deposit_bsc": MessageLookupByLibrary.simpleMessage(
            "Если у вас есть ETH, BNB или FUSE на сети Binance Smart Chain (BSC), используйте приведенный ниже URL-ссылку со своей учетной записью Metamask в браузере вашего компьютера, чтобы внести депозит на Fuse:"),
        "crypto_deposit_eth": MessageLookupByLibrary.simpleMessage(
            "Если у вас есть USDC на Ethereum, используйте приведенный ниже URL-адрес со своей учетной записью Metamask в браузере компьютера, чтобы внести депозит в Fuse:"),
        "crypto_deposit_risk": MessageLookupByLibrary.simpleMessage(
            "Обратите внимание, что это личная ссылка, по которой средства будут переведены прямо на ваш счет."),
        "crypto_deposit_risk_2": MessageLookupByLibrary.simpleMessage(
            "Пожалуйста, используйте его ответственно и на свой собственный риск."),
        "current_community":
        ...
        "deposit_failed": MessageLookupByLibrary.simpleMessage(
            "не удалось совершить депозит"),
        "deposit_from_BSC":
        ...
        "earn_description": MessageLookupByLibrary.simpleMessage(
            "Держатели Fuse Долларов имеют право получать доход в размере 5% в год, просто храня эту цифровую валюту на своем балансе."),
        ...
        "enable_text": MessageLookupByLibrary.simpleMessage(
            "Ваши контакты не будут сохранены на нашем сервере, и это действие не отправит им сообщения"),
        ...
        "enter_phone_number": MessageLookupByLibrary.simpleMessage(
            "Пожалуйста, введите свой номер телефона для настройки вашей учетной записи"),
        "enter_pincode":
            MessageLookupByLibrary.simpleMessage("Введите свой PIN-код:"),
        "enter_verification_code": MessageLookupByLibrary.simpleMessage(
            "Пожалуйста, введите 6-значный код из этого сообщение здесь"),
        ...
        "fuse_dollar": MessageLookupByLibrary.simpleMessage("Fuse Доллар"),
        "fuse_dollar_explain": MessageLookupByLibrary.simpleMessage(
            "Fuse Доллар (fUSD) - это стабильная валюта привязанная к доллару США, созданная на блокчейне Fuse Network. Она была создана, чтобы упростить криптовалюту и DeFi для ежедневных пользователей."),
        ...
        "how_to_use_fusd": MessageLookupByLibrary.simpleMessage(
            "Как вы можете использовать Fuse Доллар?"),
        ...
        "invite_friend":
            MessageLookupByLibrary.simpleMessage("Пригласить друга\n"),
        "invite_friend_text": MessageLookupByLibrary.simpleMessage(
            "Эй, твой друг поделился с тобой кошельком fuse.cash:\n"),
        "invite_text": m0,
        ...
        "not_enough_balance": MessageLookupByLibrary.simpleMessage(
            "Недостаточный баланс на вашем счету"),
        "offline":
        ...
        "pay_with": MessageLookupByLibrary.simpleMessage("Платить с "),
        ...
        "pickup_display_name_text": MessageLookupByLibrary.simpleMessage(
            "Это имя будет показано контактам, которые отправляют вам деньги, для идентификации вашей учетной записи."),
        ...
        "please_choose_security": MessageLookupByLibrary.simpleMessage(
            "Пожалуйста, выберите способ разблокировки кошелька:"),
        "please_use":
            MessageLookupByLibrary.simpleMessage("Пожалуйста, используйте"),
        "price": MessageLookupByLibrary.simpleMessage("Цена"),
        "privacy": MessageLookupByLibrary.simpleMessage("Fuse.io/privacy"),
        "protect_wallet":
            MessageLookupByLibrary.simpleMessage("Защитите свой кошелек"),
        "rate": MessageLookupByLibrary.simpleMessage("Показатель"),
        "rate_us":
            MessageLookupByLibrary.simpleMessage("Оцените нас в магазине\n"),
        "re_type_passcode":
        ...
        "review_swap": MessageLookupByLibrary.simpleMessage("Посмотреть обмен"),
        ...
        "sending_to_ethereum": MessageLookupByLibrary.simpleMessage(
            "Отправлено на ваш Ethereum кошелек"),
        ...
        "stores_private": MessageLookupByLibrary.simpleMessage(
            "Кошелек fuse хранит личную информацию локально на устройстве. Только номер телефона используется для подтверждения вашей личности для уменьшения неудобств при отправке денег по телефонным контактам."),
        ...
        "to_protect": MessageLookupByLibrary.simpleMessage(
            "Чтобы защитить свои деньги и кошелек, перейдите в настройки и сделайте резервную копию своего кошелька за несколько простых шагов."),
        ...
        "wallet_protected":
            MessageLookupByLibrary.simpleMessage("Ваш fuse кошелек защищен!"),
        ...
        "what_is_fuse_dollar":
            MessageLookupByLibrary.simpleMessage("Что такое Fuse Доллар?"),
        "what_is_peg": MessageLookupByLibrary.simpleMessage(
            "Как поддерживается привязка Fuse Доллар?"),
        "why_do_we_need_this":
        ...
        "write_word":
            MessageLookupByLibrary.simpleMessage("Пожалуйста, запишите слова"),
        ...
        "you_got_a": MessageLookupByLibrary.simpleMessage("Вы получили"),
