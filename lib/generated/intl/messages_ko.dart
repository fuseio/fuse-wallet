...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "crypto_deposit_bsc": MessageLookupByLibrary.simpleMessage(
            "Binance Smart Chain(BSC)에 FUSE나 BNB, ETH가 있으면 데스크톱 브라우저에서 Metamask 계정으로 아래 URL을 이용해 Fuse에 예치하세요."),
        "crypto_deposit_eth": MessageLookupByLibrary.simpleMessage(
            "Ethereum에 USDC가 있으면 데스크톱 브라우저에서 Metamask 계정으로 아래 URL을 이용해 Fuse에 예치하세요."),
        ...
        "earn_description": MessageLookupByLibrary.simpleMessage(
            "Fuse Dollars 소유자는 잔고에 해당 Dollars를 소지하고 있는 것만으로 일 년에 5%의 수익을 벌어들일 수 있습니다."),
